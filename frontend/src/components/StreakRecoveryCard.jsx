  ...
  return (
    <div className="relative rounded-2xl p-5 glass overflow-hidden animate-slide-up">
      ...
      <div className="flex items-start gap-3 pr-6 relative">
        <div className="w-10 h-10 rounded-xl bg-linear-to-br from-rose-400 to-pink-500 text-white flex items-center justify-center shrink-0 shadow-lg shadow-rose-500/30">
          <Heart size={18} />
        </div>
