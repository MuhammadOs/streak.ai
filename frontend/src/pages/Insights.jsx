    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="card p-6 relative overflow-hidden">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at 0% 0%, rgba(99,102,241,0.22), transparent 55%), radial-gradient(circle at 100% 100%, rgba(139,92,246,0.14), transparent 55%)",
          }}
        />
        <div className="relative">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-xl bg-linear-to-br from-brand-500 to-brand-600 text-white flex items-center justify-center shadow-lg shadow-brand-500/30">
              <Sparkles size={18} />
            </div>
